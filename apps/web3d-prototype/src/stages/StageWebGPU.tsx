 ...
 * post-processing node graph (SSGI + GTAO + Bloom + TRAA). Lighting is the single
 * shared SolarSky sun + slight ambient (the fake LTC area-light fills were removed);
 * SSGI supplies the real indirect bounce. Owns this file + WebGPUPost.tsx.
 *
...
export function StageWebGPU() {
  ...
  return (
    ...
    >
      ...
      {/* Lighting is the single SolarSky sun + slight ambient (shared with every mode);
          the fake LTC area-light fills were removed. SSGI in WebGPUPost supplies the
          real indirect bounce here — no extra light sources. */}
